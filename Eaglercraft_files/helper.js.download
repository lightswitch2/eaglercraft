...
// START OF CODE ADDED BY PROFESSOR
...
// END OF CODE ADDED BY PROFESSOR

const COUNTER = "https://api.api-ninjas.com/v1/counter?id=eaglercraft.com&hit=true";

const EAGLER_1_8_OFFLINE = [ "https://bafybeibyassrqhys6qanehkfrqgdv4zs2vlyoq5rlv2aysirzlg7ijsmkq.ipfs.dweb.link/?filename=EaglercraftX_1.8_Signed_Offline.zip", "EaglercraftX_1.8_Signed_Offline.zip" ];
...
const EAGLER_1_8_PLUGIN = [ "https://deev.is/eagler/EaglerXBungee-1.3.0.jar", "EaglerXBungee-1.3.0.jar" ];
